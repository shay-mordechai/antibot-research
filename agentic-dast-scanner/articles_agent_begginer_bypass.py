...
async def main():
    async with async_playwright() as p:
        ...
        # Initialize a new page with a legitimate Windows Google Chrome User-Agent
        page = await browser.new_page(
            user_agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36"
        )

        # Inject a manual stealth script to override the webdriver flag
        # This prevents Cloudflare from detecting the automated browser session
        ...
        with open(filename, "w", encoding="utf-8") as f:
            ...
            for url in TARGET_URLS:
                ...
                # Pause execution to mimic human behavior and avoid rate limits
